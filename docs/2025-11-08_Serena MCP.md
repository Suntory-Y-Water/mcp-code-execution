[Open in github.dev](https://github.dev/) [Open in a new github.dev tab](https://github.dev/) [Open in codespace](https://github.com/codespaces/new/oraios/serena/tree/main?resume=1)

[a8f6ad9](https://github.com/oraios/serena/commit/a8f6ad92cc67270671e1d878b30d9daccadc4015) ·
...
Serena provides the necessary [tools](https://github.com/oraios/serena/blob/main/#list-of-tools) for coding workflows, but an LLM is required to do the actual work, orchestrating tool use.

For example, **supercharge the performance of Claude Code** with a [one-line shell command](https://github.com/oraios/serena/blob/main/#claude-code).
...
- by incorporating Serena's tools into an agent framework of your choice, as illustrated [here](https://github.com/oraios/serena/blob/main/docs/custom_agent.md). Serena's tool implementation is decoupled from the framework-specific code and can thus easily be adapted to any agent framework.

A demonstration of Serena efficiently retrieving and editing code within Claude Code, thereby saving tokens and time. Efficient operations are not only useful for saving costs, but also for generally improving the generated code's quality. This effect may be less pronounced in very small projects, but often becomes of crucial importance in larger ones.

claude-code-add-command\_x264-low.mp4<video src="https://private-user-images.githubusercontent.com/35432522/475806037-ab78ebe0-f77d-43cc-879a-cc399efefd87.mp4?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..waDWZO7VNjAmsn8C5z8jypqNI3wpMmJ13URLwZk9Mtc" controls="controls"></video>
...
Serena-Add-Logo\_x264.mp4<video src="https://private-user-images.githubusercontent.com/1295099/429255707-6eaa9aa1-610d-4723-a2d6-bf1e487ba753.mp4?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..sdtkgVTdkNtNHnYu2ZoCYvtpQZ6i-Ep9bns72vT2RnM" controls="controls"></video>
...
- Scala (requires some [manual setup](https://github.com/oraios/serena/blob/main/docs/scala_setup_guide_for_serena.md); uses Metals LSP)
...
Support for further languages can easily be added by providing a shallow adapter for a new language server implementation, see Serena's [memory on that](https://github.com/oraios/serena/blob/main/.serena/memories/adding_new_language_support_guide.md).
...
- [Quick Start](https://github.com/oraios/serena/blob/main/#quick-start)
	- [Running the Serena MCP Server](https://github.com/oraios/serena/blob/main/#running-the-serena-mcp-server)
		- [Usage](https://github.com/oraios/serena/blob/main/#usage)
		- [Using uvx](https://github.com/oraios/serena/blob/main/#using-uvx)
		- [Local Installation](https://github.com/oraios/serena/blob/main/#local-installation)
		- [Using Docker (Experimental)](https://github.com/oraios/serena/blob/main/#using-docker-experimental)
		- [Using Nix](https://github.com/oraios/serena/blob/main/#using-nix)
		- [Streamable HTTP Mode](https://github.com/oraios/serena/blob/main/#streamable-http-mode)
		- [Command-Line Arguments](https://github.com/oraios/serena/blob/main/#command-line-arguments)
	- [Configuration](https://github.com/oraios/serena/blob/main/#configuration)
	- [Project Activation & Indexing](https://github.com/oraios/serena/blob/main/#project-activation--indexing)
	- [Claude Code](https://github.com/oraios/serena/blob/main/#claude-code)
	- [Codex](https://github.com/oraios/serena/blob/main/#codex)
	- [Other Terminal-Based Clients](https://github.com/oraios/serena/blob/main/#other-terminal-based-clients)
	- [Claude Desktop](https://github.com/oraios/serena/blob/main/#claude-desktop)
	- [MCP Coding Clients (Cline, Roo-Code, Cursor, Windsurf, etc.)](https://github.com/oraios/serena/blob/main/#mcp-coding-clients-cline-roo-code-cursor-windsurf-etc)
	- [Local GUIs and Frameworks](https://github.com/oraios/serena/blob/main/#local-guis-and-frameworks)
- [Detailed Usage and Recommendations](https://github.com/oraios/serena/blob/main/#detailed-usage-and-recommendations)
	- [Tool Execution](https://github.com/oraios/serena/blob/main/#tool-execution)
		- [Shell Execution and Editing Tools](https://github.com/oraios/serena/blob/main/#shell-execution-and-editing-tools)
	- [Modes and Contexts](https://github.com/oraios/serena/blob/main/#modes-and-contexts)
		- [Contexts](https://github.com/oraios/serena/blob/main/#contexts)
		- [Modes](https://github.com/oraios/serena/blob/main/#modes)
		- [Customization](https://github.com/oraios/serena/blob/main/#customization)
	- [Onboarding and Memories](https://github.com/oraios/serena/blob/main/#onboarding-and-memories)
	- [Prepare Your Project](https://github.com/oraios/serena/blob/main/#prepare-your-project)
		- [Structure Your Codebase](https://github.com/oraios/serena/blob/main/#structure-your-codebase)
		- [Start from a Clean State](https://github.com/oraios/serena/blob/main/#start-from-a-clean-state)
		- [Logging, Linting, and Automated Tests](https://github.com/oraios/serena/blob/main/#logging-linting-and-automated-tests)
	- [Prompting Strategies](https://github.com/oraios/serena/blob/main/#prompting-strategies)
	- [Running Out of Context](https://github.com/oraios/serena/blob/main/#running-out-of-context)
	- [Serena's Logs: The Dashboard and GUI Tool](https://github.com/oraios/serena/blob/main/#serenas-logs-the-dashboard-and-gui-tool)
	- [Serena and GIT worktrees](https://github.com/oraios/serena/blob/main/#serena-and-git-worktrees)
- [Comparison with Other Coding Agents](https://github.com/oraios/serena/blob/main/#comparison-with-other-coding-agents)
	- [Subscription-Based Coding Agents](https://github.com/oraios/serena/blob/main/#subscription-based-coding-agents)
	- [API-Based Coding Agents](https://github.com/oraios/serena/blob/main/#api-based-coding-agents)
	- [Other MCP-Based Coding Agents](https://github.com/oraios/serena/blob/main/#other-mcp-based-coding-agents)
- [Acknowledgements](https://github.com/oraios/serena/blob/main/#acknowledgements)
	- [Sponsors](https://github.com/oraios/serena/blob/main/#sponsors)
	- [Community Contributions](https://github.com/oraios/serena/blob/main/#community-contributions)
	- [Technologies](https://github.com/oraios/serena/blob/main/#technologies)
- [Customizing and Extending Serena](https://github.com/oraios/serena/blob/main/#customizing-and-extending-serena)
- [List of Tools](https://github.com/oraios/serena/blob/main/#list-of-tools)

## Quick Start

Serena can be used in various ways, below you will find instructions for selected integrations.

- For coding with Claude, we recommend using Serena through [Claude Code](https://github.com/oraios/serena/blob/main/#claude-code) or [Claude Desktop](https://github.com/oraios/serena/blob/main/#claude-desktop). You can also use Serena in most other [terminal-based clients](https://github.com/oraios/serena/blob/main/#other-terminal-based-clients).
- If you want a GUI experience outside an IDE, you can use one of the many [local GUIs](https://github.com/oraios/serena/blob/main/#local-guis-and-frameworks) that support MCP servers. You can also connect Serena to many web clients (including ChatGPT) using [mcpo](https://github.com/oraios/serena/blob/main/docs/serena_on_chatgpt.md).
- If you want to use Serena integrated in your IDE, see the section on [other MCP clients](https://github.com/oraios/serena/blob/main/#other-mcp-clients---cline-roo-code-cursor-windsurf-etc).
...
Note that no matter how you run the MCP server, Serena will, by default, start a small web-based dashboard on localhost that will display logs and allow shutting down the MCP server (since many clients fail to clean up processes correctly). This and other settings can be adjusted in the [configuration](https://github.com/oraios/serena/blob/main/#configuration) and/or by providing [command-line arguments](https://github.com/oraios/serena/blob/main/#command-line-arguments).
...
When using instead the *Streamable HTTP* mode, you control the server lifecycle yourself, i.e. you start the server and provide the client with the URL to connect to it.
...
The Serena MCP server supports a wide range of additional command-line options, including the option to run in Streamable HTTP or SSE mode and to adapt Serena to various [contexts and modes of operation](https://github.com/oraios/serena/blob/main/#modes-and-contexts).
...
2. In the arguments passed to the `start-mcp-server` in your client's config (see below), which will apply to all sessions started by the respective client. In particular, the [context](https://github.com/oraios/serena/blob/main/#contexts) parameter should be set appropriately for Serena to be best adjusted to existing tools and capabilities of your client. See for a detailed explanation. You can override all entries from the `serena_config.yml` through command line arguments.
3. In the `.serena/project.yml` file within your project. This will hold project-level configuration that is used whenever that project is activated. This file will be autogenerated when you first use Serena on that project, but you can also generate it explicitly with
	...
	```
	(or use the `--directory` command version).
4. Through the context and modes. Explore the [modes and contexts](https://github.com/oraios/serena/blob/main/#modes-and-contexts) section for more details.
...
where `<serena-mcp-server>` is your way of [running the Serena MCP server](https://github.com/oraios/serena/blob/main/#running-the-serena-mcp-server). For example, when using `uvx`, you would run
...
For [Claude Desktop](https://claude.ai/download) (available for Windows and macOS), go to File / Settings / Developer / MCP Servers / Edit Config, which will let you open the JSON file `claude_desktop_config.json`. Add the `serena` MCP server configuration, using a [run command](https://github.com/oraios/serena/blob/main/#running-the-serena-mcp-server) depending on your setup.
...
ℹ️ You can further customize the run command using additional arguments (see [above](https://github.com/oraios/serena/blob/main/#command-line-arguments)).
...
⚠️ Some clients may leave behind zombie processes. You will have to find and terminate them manually then. With Serena, you can activate the [dashboard](https://github.com/oraios/serena/blob/main/#serenas-logs-the-dashboard-and-gui-tool) to prevent unnoted processes and also use the dashboard for shutting down Serena.
...
Serena combines tools for semantic code retrieval with editing capabilities and shell execution. Serena's behavior can be further customized through [Modes and Contexts](https://github.com/oraios/serena/blob/main/#modes-and-contexts). Find the complete list of tools [below](https://github.com/oraios/serena/blob/main/#full-list-of-tools).
...
When it comes to serena AND git-worktree AND larger projects (that take longer to index), the recommended way is to COPY your `$ORIG_PROJECT/.serena/cache` to `$GIT_WORKTREE/.serena/cache`. After you have performed pre-indexing of your project described in [Project Activation & Indexing](https://github.com/oraios/serena/blob/main/#project-activation--indexing) section. To avoid having to re-index per each git work tree that you create.
...
We look forward to seeing what the community will come up with! For details on contributing, see [contributing guidelines](https://github.com/oraios/serena/blob/main/CONTRIBUTING.md).
